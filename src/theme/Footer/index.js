...
function Footer() {
	...
	// 	elem.setAttribute("src", "img/EFI_RGB.png");
	//   }
	...
	return (
			...
			<section className="footer-container">
				<div className='container1'>
					<div className='left-section'>
						<span className='textblack'>Efí Bank</span><br />
						<span>Av Paulista, 1337, Edifício Paulista 1 - Bela Vista, São Paulo, SP - 01311-200, Brasil</span>
					</div>
					<div className="right-section">
						<div className='right-text'>
							<span className='textblack'>(11) 2394 2208</span><br />
							<span>São Paulo e região</span>
						</div>
						<div className='right-text'>
							<span className='textblack'>0800 941 2343</span><br />
							<span>Ligações de telefone fixo</span>
						</div>
						<div className='right-text'>
							<span className='textblack'>4000 1234</span><br />
							<span>Regiões metropolitanas</span>
						</div>
						<div className='right-text'>
							<span className='textblack'>0800 940 0361</span><br />
							<span>Ouvidoria</span>
						</div>
				...
				<div className="footer">
					...
					<a href="https://sejaefi.com.br/efi-bank" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="65.161" height="51.056" viewBox="0 0 65.161 51.056">
						...
						<div className='logo-text'>
							<span>© 2007-2023 • Efí - Instituição de Pagamento. Todos os direitos reservados. Efí S.A. CNPJ: 09.089.356/0001-18</span>
						</div>

					</div>
					<div className="footer-redes"> 
						<a href="https://www.youtube.com/@sejaefi"><img className="redes" src="/img/rede1.svg" /></a>
						<a href="https://www.instagram.com/sejaefi/" target="_blank"><img className="redes" src="/img/rede2.svg" /></a>
						<a href="https://www.linkedin.com/company/sejaefi/" target="_blank"><img className="redes" src="/img/rede-3.svg" /></a>
						<a href="https://www.facebook.com/sejaefi" target="_blank"><img className="redes" src="/img/rede-4.svg" /></a>
						<a href="https://twitter.com/sejaefi" target="_blank"><img className="redes" src="/img/rede-5.svg" /></a>
						<a href="https://www.tiktok.com/@sejaefi" target="_blank"><img className="redes" src="/img/rede-6.svg" /></a>
					</div>
				</div>
			</section>
		</footer>
		...
		// <footer id="footer">
		// 	<div>
		// 		© 2007 - 2023 Efí. Todos os direitos reservados.
		// 	</div>
		// 	<div className="create-account">Conheça a <a className="link portal-link" href="https://sejaefi.com.br/">Efí </a>e <a className="link portal-link" href="https://sejaefi.com.br/">abra já a sua conta grátis</a>.
		// 	</div>
		// </footer>
	);
}
