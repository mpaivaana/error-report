...
class AccountIdentifierEn extends React.Component {
    constructor(props) {
      super(props);
    ...
    handleSubmit(event) {
      ...
      if(id_client !==null && id_client!==""){
          ...
          var hdesenvolvimento = <h2>Sandbox</h2>
          var hproducao = <h2>Production</h2>
      ...
      return (
          <div>
              <form onSubmit={this.handleSubmit}>
                  <label>
                  <input type="text" placeholder="Account identifier" className="input_account" value={this.state.value} onChange={this.handleChange} />
                  </label>
                  <input type="submit" className="buttonInput" value="Generate" />
              </form>
              <div>
                <br>
                </br>
  ...
  export default AccountIdentifierEn