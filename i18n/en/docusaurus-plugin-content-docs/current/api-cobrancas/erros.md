---
id: erros
title: Interpreting API errors
hide_title: true
sidebar_label: Interpreting API errors
---
<h1 className="titulo">Interpreting API errors</h1>
...
This page aims to present the 'Request History', which allows integrators to view all requests made by their application to the Efí API. The page also includes information on how to check the error codes returned by our API, which will enable you to understand the API responses, correct possible data validation errors or similar issues, and identify the requests made by your application to our web services. Both flows are detailed below:
...
- <a href="https://sejaefi.com.br/#login" target="_blank" title="External Link">Log in</a> to your Efí account;
- Go to <code>API > Aplicações > Your Application</code>;
- Choose the environment used (production or testing) and click on <code>Histórico de Requisições</code> (<a href="https://sejaefi.link/H1x2CNAhr3" target="_blank">see where</a>).

Check out the video where we teach how to use the API "Request History":

<div className = "video">
<iframe width="560" height="315" src="https://www.youtube.com/embed/4F-DQ6Dhdro" title="[Module 6] Lesson 1 - Interpreting API errors | Gerencianet API Course 2.0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>

<br/>


## Error Codes Returned in the Efí Billings API

This section presents the error codes that can be returned in the Efí Billings API.
...
### Learning to Search for Efí API Error Codes

To facilitate understanding of each error returned by our APIs, we provide a page that lists all errors for consultation.

To access it, click <a href="https://gerencianet.github.io/gn-erros-api/" target="_blank" title="External Link"><b>here</b></a>.

<div className="figure"><img src="https://files.readme.io/adf97a7-consultando_error_exemplo.gif" width="1920"/><p>Checking error codes - Efí API</p></div>

<br/>

## Reasons for Credit Card Transaction Rejections

There are several reasons why a credit card payment may be declined.  
Download the available PDF below or <a href="https://gerencianet-pub-prod-1.s3.amazonaws.com/Motivos+de+recusa+de+cart%C3%A3o+(1).pdf" target="_blank">here</a> to learn about the possible reasons for this decline, as returned by the API.
